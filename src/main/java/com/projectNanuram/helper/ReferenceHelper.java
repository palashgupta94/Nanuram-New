...
public class ReferenceHelper {
    ...
    public static Map<String , Map<? , ?>> referenceData(){
        ...
        Map<String , Map<? , ?>> referenceData = new LinkedHashMap<>();
...
//        ///////////////////////////////////////////////
        ...
        Map<String , Boolean> primary = new LinkedHashMap<>();
        primary.put("True" , true);
        primary.put("False" , false);

//        //////////////////////////////////////////////

        Map<String , AddressType> addressTypeMap = new LinkedHashMap<>();
...
//        Collections.sort(rowList);
        ...
        Map<Integer , String> intRowMap = new LinkedHashMap<>();

        List<Integer> intRowList = new ArrayList<>();
        for(int i = 1; i <= 50 ; i++){
            intRowList.add(i);
        }
        for(Integer i : intRowList){
            intRowMap.put(i , ""+i);
        }

        ///////////////////////////////////////////////////////////////////

        Map<String , String> stringRowMap = new LinkedHashMap<>();

        List<Integer> stringRowList = new ArrayList<>();
        for(int i = 1; i <= 50 ; i++){
            stringRowList.add(i);
        }
        for(Integer i : stringRowList){
            stringRowMap.put(""+i , ""+i);
        }
        ...
        referenceData.put("intRowMap" , intRowMap);
        referenceData.put("stringRowMap" , stringRowMap);
