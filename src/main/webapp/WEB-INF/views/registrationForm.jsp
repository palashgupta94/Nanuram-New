...
<div class="formContainer mt-3" >
    ...
    <form:form action="save" method="post"  enctype="multipart/form-data" modelAttribute="personWrapper">
...
<%--                ---------------------------------------------------------------------------------------------%>
                ...
                <td>
                    <div class="mb-3">
                        <form:input path="members[${i}].imageFile"  class="form-control form-control-sm" id="formFileSm" type="file" name="imgFile" />
